      ...
      >
          ...
          <div className="absolute inset-0 animate-spin-slow-reverse">
            ...
            >
              <img
                ...
                alt=""
                className="w-full h-full object-cover opacity-40 rounded-full"
              />
            </div>
          </div>
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-end pb-24 gap-6">
          <div className="w-16 h-16 rounded-2xl shadow-lg overflow-hidden mb-2 ring-1 ring-white/10">
            <img src="https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?q=80&w=1696&auto=format&fit=crop" alt="Workspace" className="w-full h-full object-cover" />
          </div>
          ...
          <p className="text-lg font-medium" style={{ color: colors.textSecondary }}>
            Elevate your visual storytelling. Join the waitlist.
          </p>
            ...
            >
              ...
              >
                <div className="bg-white/20 p-1 rounded-full">
                  <Check className={`w-5 h-5 ${status === "success" ? "animate-checkmark" : ""}`} strokeWidth={3} />
                </div>
