...
const PixelTrail = ({
  ...
  // Attach global mouse event listener instead of attaching it to the container
  // This allows pointer-events-none on the container so it doesn't block clicks.
  useEffect(() => {
  ...
  return (
    ...
    >
      {rows > 0 && columns > 0 && Array.from({ length: rows }).map((_, rowIndex) => (
